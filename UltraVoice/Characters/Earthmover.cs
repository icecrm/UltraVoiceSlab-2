        ...
        static void Postfix(AudioSource __instance)
        {
            ...
            static IEnumerator Detected()
            {
                ...
                var src = VoiceManager.CreateVoiceSource(
                      ...
                      "WARNING: HOSTILE FOREIGN MACHINE ID DETECTED.",
                      true,
                      volumeMult: 3f,
                      spatialBlend: 0f
                );
        ...
        static void Postfix(Crossfade __instance)
        {
            ...
            static IEnumerator BloodVent()
            {
                ...
                var src = VoiceManager.CreateVoiceSource(
                      ...
                      "CONTAMINATION DETECTED IN SYSTEMS.",
                      true,
                      volumeMult: 3f,
                      spatialBlend: 0f
                );
                ...
                VoiceManager.ShowSubtitle("DRAINING SYSTEMS INITIATED.", src);
            }
        }
    }
        ...
        static void Postfix(CombinedBossBar __instance)
        {
            ...
            static IEnumerator DefenseSystem()
            {
                ...
                var src = VoiceManager.CreateVoiceSource(
                      ...
                      "HOSTILE DETERRENT SYSTEM ACTIVE.",
                      true,
                      volumeMult: 3f,
                      spatialBlend: 0f
                );
                ...
                VoiceManager.ShowSubtitle("ALL SHIELDS ONLINE.", src);
            }
        }
    }
        ...
        static void Postfix(GameObject __instance)
        {
            ...
            static IEnumerator BloodFlood()
            {
                var src = VoiceManager.CreateVoiceSource(
                      ...
                      "WARNING: DEPLOYING EMERGENCY INTERIOR FLOODING.",
                      true,
                      volumeMult: 3f,
                      spatialBlend: 0f
                );
                ...
                VoiceManager.ShowSubtitle("INTERIOR FLOODING", src);
            }
        }
    }
        ...
        static void Postfix(GameObject __instance)
        {
            ...
            static IEnumerator BrainBattle()
            {
                var src = VoiceManager.CreateVoiceSource(
                      ...
                      "WARNING: INTERIOR COMMAND CENTER BREACHED.",
                      true,
                      volumeMult: 3f,
                      spatialBlend: 0f
                );
                ...
                VoiceManager.ShowSubtitle("DEPLOYING LAST LINE OF DEFENSE.", src);
            }
        }
    }
        ...
        static void Postfix(GameObject __instance)
        {
            ...
            static IEnumerator SelfDestruct()
            {
                ...
                var src = VoiceManager.CreateVoiceSource(
                      ...
                      "EMERGENCY HULL DESTRUCTION IMMINENT. ALL PERSONNEL EVACUATE IMMEDIATELY.",
                      true,
                      volumeMult: 3f,
                      spatialBlend: 0f
                );
                ...
                VoiceManager.ShowSubtitle("EMERGENCY HULL DESTRUCTION IMMINENT.", src);
