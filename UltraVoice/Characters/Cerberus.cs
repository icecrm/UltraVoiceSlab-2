...
namespace UltraVoice.Characters
{
    public class CerberusCharacter
    {
        ...
        {
            "This land is not for you to tarnish.",
            "Your wretched ways are not welcome in this land.",
            "Return whence you came.",
            "You tread forbidden ground.",
            "Now, halt.",
            "You tread forbidden ground, Ironclad."
        };

        public static readonly string[] EnrageSubs =
        {
            "You have made a vital mistake",
            "Your hubris will not go unpunished",
            "You shall be laid to rest",
